...
void test_compute_homography()
{
    ...
    Hp.data[0][0] = -0.1328042;
    Hp.data[0][1] = -0.2910411;
    Hp.data[0][2] = 0.8103200;
    Hp.data[1][0] = -0.0487439;
    Hp.data[1][1] = -1.3077799;
    Hp.data[1][2] = 1.4796660;
    Hp.data[2][0] = -0.0788730;
    Hp.data[2][1] = -0.3727209;
    Hp.data[2][2] = 1.0000000;
...
void test_exact_box_filter_image()
{
    ...
    // printf("avg origin difference test: %f\n", avg_diff(smooth, dog));      // !!! Edit: uncomment line
    // printf("avg smooth difference test: %f\n", avg_diff(smooth, smooth_t)); // !!! Edit: uncomment line
    TEST(same_image(smooth, smooth_t, EPS * 3));   // !!! Edit: change from EPS * 3 to EPS * 2
...
void test_good_enough_box_filter_image()
{
    ...
    // printf("avg origin difference test: %f\n", avg_diff(smooth_c, dog_c));    // !!! Edit: uncomment line
    // printf("avg smooth difference test: %f\n", avg_diff(smooth_c, smooth_t)); // !!! Edit: uncomment line
